window.POMS_CONFIG = {
  ...
  LINE: {
    LIFF_ID: "",
    RICH_MENU: [
      { label: "勤怠報告", url: "https://pos-driver-system.vercel.app/attendance.html" },
      { label: "前払い申請", url: "https://pos-driver-system.vercel.app/advance.html" },
      { label: "休み希望", url: "https://pos-driver-system.vercel.app/holiday.html" }
    ]
  },
  ADMIN_AUTH: {
    enabled: true,
