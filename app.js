(function () {
  ...
  async function initAttendance() {
    ...
    function render() {
      ...
      $("startWorkBtn").disabled = saving;
      $("endWorkBtn").disabled = saving;
      $("startWorkSwipe").classList.toggle("hidden", working || finished);
      $("endWorkSwipe").classList.toggle("hidden", !working);
      setSwipeConfirmEnabled("startWorkSwipe", !saving && !working && !finished);
      setSwipeConfirmEnabled("endWorkSwipe", !saving && working);
